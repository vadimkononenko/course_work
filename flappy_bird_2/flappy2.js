...
class Score extends GamePart {
    ...
    render() {
        if (
            this.game.state.is(GameState.Play) ||
            ...
            if (this.current >= 1000) {
                ...
                this.game.canvas.ctx.drawImage(
                    this.game.themes.get(2),
                    GameMap.get()[ones].imgX,
                    GameMap.get()[ones].imgY,
                    GameMap.get()[ones].width,
                    GameMap.get()[ones].height,
                ...
                this.game.canvas.ctx.drawImage(
                    this.game.themes.get(2),
                    GameMap.get()[tens].imgX,
                    GameMap.get()[tens].imgY,
                    GameMap.get()[tens].width,
                    GameMap.get()[tens].height,
                    this.x - this.w / 2,
                    this.y,
                    this.w,
                    this.h
                ...
                this.game.canvas.ctx.drawImage(
                    this.game.themes.get(2),
                    GameMap.get()[hundreds].imgX,
                    GameMap.get()[hundreds].imgY,
                    GameMap.get()[hundreds].width,
                    GameMap.get()[hundreds].height,
                    this.x - this.w / 2 - this.w - 3,
                    this.y,
                    this.w,
                    this.h
...
class Bird extends GamePart {
    ...
    position() {
        if (this.game.state.is(GameState.GetReady)) {
            ...
            if (
                this.y + this.h / 2 >=
                this.game.canvas.cvs.height - this.game.rendering.ground.h
            ) {
                this.y =
                    this.game.canvas.cvs.height -
                    this.game.rendering.ground.h -
                    this.h / 2;
...
class Game {
    ...
    draw() {
        ...
        this.canvas.ctx.fillRect(
            0,
            0,
            this.canvas.cvs.width,
            this.canvas.cvs.height
        );
